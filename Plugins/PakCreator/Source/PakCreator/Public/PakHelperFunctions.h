...
public:
	...
	static FString MakeUATCommand(const FString& UProjectFile, const FString& PlatformName, const FString& Cookflavor, const FString& ConfigurationName, const FString& StageDirectory, bool bCompress);
